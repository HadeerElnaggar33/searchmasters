...
const POINTS = [
  ...
  ["نقاط الساعات", [
    ["pts_hour_normal",   "ساعة في يوم عمل",        "بتتحسب من سجل الحضور"],
    ["pts_hour_extra",    "ساعة خارج أيام العمل",   "الجمعة والسبت والعطلات"],
    ["pts_hour_training", "ساعة تدريب",             "لقسم نتعلم سوا — لسه ما اتبناش"],
  ]],
  ["مؤشر الضغط اليومي", [
    ["press_w_open",   "وزن كل تاسك مفتوحة",          ""],
    ["press_w_due",    "وزن كل تسليم النهاردة أو بكرة", ""],
    ["press_w_urgent", "وزن كل تاسك عاجلة",           ""],
    ["press_w_hours",  "وزن الساعات الأعلى من معدله",  "لو زاد 25% عن متوسطه"],
    ["press_th_high",  "عتبة «مرتفع»",                "المؤشر من كام"],
    ["press_th_very",  "عتبة «عالي جداً»",            ""],
    ["press_mult_high","معامل المرتفع",               "1.25 يعني +25%"],
    ["press_mult_very","معامل العالي جداً",           "1.5 يعني +50%"],
  ]],
];
